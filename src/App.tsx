            ...
            >
              <div className="px-6 py-10 flex flex-col gap-8">
                {navLinks.map((item) => (
                  <button 
                    key={item} 
                    className="text-3xl font-black uppercase hover:text-primary transition-colors text-left py-2"
                    onClick={() => {
                      setIsMenuOpen(false);
                      if (item === 'Custom') setCurrentPage('custom');
                      if (item === 'Shop') setCurrentPage('shop');
                ...
                <div className="flex flex-col gap-6 pt-8 border-t-2 border-gray-100">
                  <button className="flex items-center gap-4 font-bold uppercase text-lg">
